...
<div id="login_content">
    ...
    <form method="POST" action="login.php">
        <table class="login_table">
            <tr><th colspan="2" class="intro"><h1>King Video Poker</h1></th></tr>
            <tr>
                <th colspan="2"><div class="login_header">Login to Your Account</div></th></tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><div class="login_submit"><input type="submit" value="LOGIN" name="<?php echo LOGIN_BUTTON_VALUE; ?>"></div></td>
            </tr>
        </table>
        ...
        <table class="login_table">
            ...
            <tr>
                <td colspan="2"><div class="login_submit"><input type="submit" value="REGISTER" name="<?php echo REGISTER_BUTTON_VALUE; ?>"></div></td>
            </tr>
        </table>
    </form>
</div>
